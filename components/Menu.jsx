        ...
        <section className='pt-12 pb-16 xl:pt-16 xl:pb-36'>
            <div className="container mx-auto">
                <div className='flex flex-col gap-4 mb-12 xl:mb-24'>
                    ...
                    <p className='text-center max-w-[620px] mx-auto'>Indulge in rich, aromatic brews crafted from the finest beans. From bold espressos to creamy lattes, our menu awakens your senses.</p>
                </div>
                    ...
                    <div className='w-full grid grid-cols-1 xl:grid-cols-2 gap-y-8 gap-x-16 place-content-center'>
                        {
                            menuItems.map((item, index) => {
                                ...
                                return (
                                    <MenuItem name={name} description={description} imgSrc={imgSrc} price={price} key={index} />
                                )
                            })
                        }
                    </div>
